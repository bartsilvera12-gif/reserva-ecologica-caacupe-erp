...
const MENU_STRUCTURE: MenuItem[] = [
  ...
  // Caja y arqueo NO va en el sidebar: se accede desde Reportes (igual que
  // Ferretería República). La ruta /caja sigue activa (gate por slug 'caja').
  {
    key: "compras",
    slug: "compras",
    label: "Compras",
  ...
  { key: "ordenes_compra", slug: "ordenes_compra", label: "Órdenes de compra", href: "/compras/ordenes", icon: ClipboardList },
