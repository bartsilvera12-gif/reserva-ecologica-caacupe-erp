...
/**
 * Módulo de caja reutilizable: turno (apertura/cierre/arqueo), movimientos e
 * historial. Se usa como página completa en /caja (desde Reportes) y embebido
 * en modo `compact` dentro del POS /ventas (sin encabezado ni historial), para
 * que el cajero opere la caja desde donde vende (patrón Ferretería República).
 */
